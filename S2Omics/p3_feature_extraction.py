...
Args:
    ...
    model_path: the path to UNI parameter files (pytorch_model.bin), /home/musuyuan/UNI/assets/ckpts/vit_large_patch16_224.dinov2.uni_mass100k/ for an example
...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default='/home/msyuan/UNI/assets/ckpts/vit_large_patch16_224.dinov2.uni_mass100k/')
