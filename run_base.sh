...
python p3_feature_extraction.py  ${prefix} --device=${device} --model_path './checkpoints/' --down_samp_step 5

# get histology segmentations
python p4_get_histology_segmentation.py ${prefix} --down_samp_step 5 --num_histology_clusters 25
python p5_merge_over_clusters.py ${prefix}

# ROI selection
python p6_roi_selection.py ${prefix} --down_samp_step 5 --roi_size 2 2 
