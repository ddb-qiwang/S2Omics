...
#python p3_feature_extraction.py  ${prefix} --save_folder ${save_folder} --ckpt_path './checkpoints/' --device=${device}

# get histology segmentations
# default setting use PCA + K-means++ + merging over-clusters
#python p4_get_histology_segmentation.py ${prefix} --save_folder ${save_folder}
