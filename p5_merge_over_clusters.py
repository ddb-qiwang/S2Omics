...
Return:
    ...
    ----pickle_files (subsubfolder)
        ...
        adjusted_cluster_image: adjusted histology cluster matrix, superpixels with no cell are assigned with -1
...
def get_args():
    ...
    parser.add_argument('--target_n_clusters', type=int, default=15, help='only when using kmeans')
...
def main():
    ...
    if num_histology_clusters > args.target_n_clusters:
        ...
        ncluster_to_reduce = num_histology_clusters - args.target_n_clusters -1
